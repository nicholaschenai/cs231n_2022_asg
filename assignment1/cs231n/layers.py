...
def affine_backward(dout, cache):
    ...
    # for this, imagine the b 'matrix' is just a ones vector times b vector
    # i.e. it copies the rows of b
...
def relu_forward(x):
    ...
    # Note to self: better soln out = np.maximum(0, x)
...
def svm_loss(x, y):
    ...
    dx = (M - M_reduced * one_hot) / num_train
